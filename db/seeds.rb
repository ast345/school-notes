...
Subject.create(subject_name: "行事", yomigana: "ぎょうじ")
...
'倫理', '政治・経済', 'コミュニケーション英語Ⅰ', '英語表現Ⅰ',  '社会と情報', '音楽Ⅱ', '美術Ⅱ', '工芸Ⅱ', '書道Ⅱ', 'コミュニケーション英語Ⅱ', 'コミュニケーション英語Ⅲ', '英語表現Ⅱ', '英語会話', '音楽Ⅲ', '美術Ⅲ', '工芸Ⅲ', '書道Ⅲ','国語総合', '国語表現', '現代文Ａ', '古典Ａ', '世界史Ａ', '日本史Ａ', '地理Ａ', 'コミュニケーション英語基礎', '英語会話', '科学と人間生活',
'物理基礎', '化学基礎', '生物基礎', '地学基礎', '家庭基礎', '情報の科学', '総合的な学習の時間', '保健', '現代文Ｂ', '古典Ｂ', '世界史Ｂ', '日本史Ｂ', '地理Ｂ', '倫理', '家庭総合', '生活デザイン', '社会と情報',
'保健', '音楽Ⅰ', '美術Ⅰ', '工芸Ⅰ', '書道Ⅰ', '外国語', '保健体育']
...
小学1年生
subject_for1 =  ['国語', '算数', '音楽', '体育', '生活', '道徳', '図画工作', '特別活動', '書写', '行事']
...
# 小学2年生
subject_for2 =  ['国語', '算数', '音楽', '体育', '生活', '道徳', '図画工作', '特別活動', '書写', '行事']
...
# 小学3年生
subject_for3 =   ['国語', '社会', '算数', '理科', '音楽', '図画工作', '体育', '道徳', '総合', '特別活動', '書写', '保健', '行事']
...
# 小学4年生
subject_for4 =   ['国語', '社会', '算数', '理科', '音楽', '図画工作', '体育', '道徳', '総合', '特別活動', '書写', '保健', '行事']
...
# 小学5年生
subject_for5 =   ['国語', '社会', '算数', '理科', '音楽', '図画工作', '家庭', '体育', '道徳', '外国語活動', '総合', '特別活動', '書写', '保健', '行事']
...
# 小学6年生
subject_for6 =   ['国語', '社会', '算数', '理科', '音楽', '図画工作', '家庭', '体育', '道徳', '外国語活動', '総合', '特別活動', '書写', '保健', '行事']
